...
Partes destes trabalho foram realizadas com o auxílio de Ferrramentas de IA. Em especial em debugging de código,
implementação de novas features, revisão textual e limpezas gerais. Em todas suas instâncias, essas ferramentas foram
utilizadas como suporte, não substituindo os objetivos de aprendizado do curso.
