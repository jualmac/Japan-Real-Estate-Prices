...
MUNICIPALITY_CODE_FILE: Path = DATASETS_DIR / "municipality_code.csv"
DISTRICT_CODE_FILE: Path = DATASETS_DIR / "district_code.csv"
...
class Config:
    ...
    use_gpu: bool = True
    models: Tuple[str, ...] = ("xgb", "lgbm", "enet", "svr")
