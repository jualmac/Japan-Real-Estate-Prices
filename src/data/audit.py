...
def build_model_input_splits(
    ...
    for split_name, (X, y_log) in splits.items():
        ...
        frame.insert(0, "study_name", study_name)
...
def save_model_input_splits(
    ...
    """
    audit_df = build_model_input_splits(run_id, study_name, splits)
...
def save_model_metrics(
    ...
    """
    metrics_df = build_metrics_audit_frame(run_id, study_name, metrics_by_split)
    DBConnection(database_file).insert_dataframe(
        metrics_df,
